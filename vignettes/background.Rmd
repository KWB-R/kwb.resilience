...
The first version of kwb.resilience was developped at [Kompetenzzentrum Wasser Berlin](www.kompetenz-wasser.de) in the framework of the project [netWORKS 4](http://www.kompetenz-wasser.de/en/project/networks/), financed by the German Ministry of Education and Research in the program [FONA](http://www.fona.de). 



## How to use kwb.resilience

Install the package using devtools as follows. For more information check documentation of single functions and the [tutorial](https://kwb-r.github.io/kwb.resilience/dev/articles/tutorial.html). 
